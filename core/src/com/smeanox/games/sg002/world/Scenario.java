...
public class Scenario {
	...
	public Scenario(String id, String name, int startMoney, int maxPlayerCount, int mapSizeX,
					int mapSizeY, boolean walkDiagonal, int startGameObjectMinDistance, int seed, int maxGold) {
	...
	public Scenario(String id, String name, int startMoney, int maxPlayerCount, int mapSizeX,
					int mapSizeY, boolean walkDiagonal, int startGameObjectMinDistance, int seed, Point[] goldPos, Point[] startPos) {
		this.id = id;
		this.name = name;
		this.startMoney = startMoney;
		this.maxPlayerCount = maxPlayerCount;
